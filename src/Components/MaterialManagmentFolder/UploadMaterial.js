    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                <div className="uploadFileContainer" style={{ backgroundImage: `url(${imageUrl})` }}>
                    ...
                    <div style={{ width: "50%", display: "flex", justifyContent: "center", alignItems: "center" }}>
                        {imageUrl ? <img src={imageUrl} style={{ width: "100%", height: "100%", marginRight: "20px", borderRadius: "7px" }} alt="Preview"></img> : <span>Select file to see preview...</span>}
                    </div>
                </div>
